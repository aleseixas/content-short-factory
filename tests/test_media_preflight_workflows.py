...
class MediaPreflightWorkflowTests(unittest.TestCase):
    ...
    def test_auth_probe_only_does_not_resolve_or_handoff_another_episode(self):
        ...
        for name in ("Resolve test episode visual candidates without publishing",
        ...
        self.assertIn("test_episode:", workflow)
        self.assertIn("TEST_EPISODE: ${{ inputs.test_episode", workflow)
